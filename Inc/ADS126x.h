...
#define POWER_DEFAULT_VALUE					(0x01)			/* CONFIGURATION REGISTER 0 (ADDRESS 01h) */
#define INTERFACE_DEFAULT_VALUE				(0x05)			/* CONFIGURATION REGISTER 1 (ADDRESS 02h) */
#define MODE0_DEFAULT_VALUE					(0x47)
#define MODE1_DEFAULT_VALUE					(0x00)
#define MODE2_DEFAULT_VALUE					(0x09)
...
extern volatile uint8_t ADS126x_Ready_flag;
